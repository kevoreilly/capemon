...
extern "C" DWORD64 X64Call(DWORD func, int argC, ...)
{
	va_list args;
	va_start(args, argC);
...
extern "C" DWORD GetModuleHandle64(wchar_t* lpModuleName)
{
	DWORD module = 0;
...
extern "C" DWORD GetProcAddress64(DWORD hModule, char* funcName)
{
...
extern "C" SIZE_T VirtualQueryEx64(HANDLE hProcess, DWORD64 lpAddress, MEMORY_BASIC_INFORMATION64* lpBuffer, SIZE_T dwLength)
{
...
extern "C" BOOL VirtualProtectEx64(HANDLE hProcess, DWORD64 lpAddress, SIZE_T dwSize, DWORD flNewProtect, DWORD* lpflOldProtect)
{
