...
private:
	...
	ModuleInfo * findModuleByName(CHAR *name);
	...
	ApiInfo * getScoredApi(ApiList::iterator it1,size_t countDuplicates, bool hasName, bool hasUnicodeAnsiName, bool hasNoUnderlineInName, bool hasPrioDll,bool hasPrio0Dll,bool hasPrio1Dll, bool hasPrio2Dll, bool firstWin );
