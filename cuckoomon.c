...
static hook_t g_hooks[] = {
	...
	HOOK_SPECIAL(ntdll, NtQueueApcThread),
	HOOK_SPECIAL(ntdll, NtQueueApcThreadEx),
	HOOK_SPECIAL(ntdll, NtCreateThread),
	HOOK_SPECIAL(ntdll, NtCreateThreadEx),
	HOOK_SPECIAL(ntdll, NtSetContextThread),
    HOOK_SPECIAL(ntdll, NtResumeThread),
	HOOK_SPECIAL(ntdll, NtSuspendThread),
	HOOK_SPECIAL(ntdll, NtMapViewOfSection),
	HOOK_SPECIAL(ntdll, NtWriteVirtualMemory),
	HOOK_SPECIAL(ntdll, NtWow64WriteVirtualMemory64),
	HOOK_SPECIAL(ntdll, NtCreateProcess),
	HOOK_SPECIAL(ntdll, NtCreateProcessEx),
    HOOK_SPECIAL(ntdll, NtResumeProcess),
	HOOK_SPECIAL(ntdll, NtCreateUserProcess),
	HOOK_SPECIAL(ntdll, RtlCreateUserThread),
	HOOK_SPECIAL(ntdll, RtlCreateUserProcess),
	HOOK_SPECIAL(ntdll, NtTerminateThread),
    HOOK_SPECIAL(kernel32, CreateProcessInternalW),
    HOOK_SPECIAL(kernel32, CreateThread),
    HOOK_SPECIAL(kernel32, CreateRemoteThread),
    HOOK_SPECIAL(kernel32, WriteProcessMemory),
