...
//	HOOK(user32, EnumWindows),	// Disable for now, invokes a user-specified callback that can contain
	...
	// Trace Hooks
	HOOK(Sechost.dll, CloseTrace),
	HOOK(Sechost.dll, ControlTraceA),
	HOOK(Sechost.dll, ControlTraceW),
	HOOK(Advapi32.dll, EnableTrace),
	HOOK(Advapi32.dll, EnableTraceEx),
	HOOK(Sechost.dll, EnableTraceEx2),
	HOOK(Sechost.dll, OpenTraceA),
	HOOK(Sechost.dll, OpenTraceW),
	HOOK(Sechost.dll, QueryAllTracesA),
	HOOK(Sechost.dll, QueryAllTracesW),
	HOOK(Advapi32.dll, QueryTraceA),
	HOOK(Advapi32.dll, QueryTraceW),
	HOOK(Sechost.dll, StartTraceA),
	HOOK(Sechost.dll, StartTraceW),
	HOOK(Sechost.dll, StopTraceA),
	HOOK(Sechost.dll, StopTraceW),
	HOOK(Advapi32.dll, UpdateTraceA),
	HOOK(Advapi32.dll, UpdateTraceW),
	HOOK(Advapi32.dll, CveEventWrite),
	HOOK(Sechost.dll, EventAccessControl),
	HOOK(Advapi32.dll, EventAccessQuery),
	HOOK(Sechost.dll, EventAccessRemove),
	HOOK(Advapi32.dll, EventRegister),
	HOOK(Advapi32.dll, EventSetInformation),
	HOOK(Advapi32.dll, EventUnregister), 
