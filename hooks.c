...
//	HOOK(user32, EnumWindows),	// Disable for now, invokes a user-specified callback that can contain
	...
	HOOK(vbscript, Hex),
	HOOK(vbscript, Oct),
	HOOK(vbscript, VarType),
	HOOK(vbscript, IsDate),
	HOOK(vbscript, IsEmpty),
	HOOK(vbscript, IsNull),
	HOOK(vbscript, IsNumeric),
	HOOK(vbscript, IsArray),
	HOOK(vbscript, IsObject),
	HOOK(vbscript, Atn),
	HOOK(vbscript, Cos),
	HOOK(vbscript, Sin),
	HOOK(vbscript, Tan),
	...
	HOOK(vbscript, Log),
	HOOK(vbscript, Sqr),
	HOOK(vbscript, Randomize),
	HOOK(vbscript, Rnd),
	HOOK(vbscript, Timer),
	HOOK(vbscript, LBound),
	HOOK(vbscript, UBound),
	HOOK(vbscript, RGB),
	HOOK(vbscript, Len),
	HOOK(vbscript, LenB),
	HOOK(vbscript, Left),
	HOOK(vbscript, LeftB),
	HOOK(vbscript, Right),
	HOOK(vbscript, RightB),
	HOOK(vbscript, Mid),
	HOOK(vbscript, MidB),
	HOOK(vbscript, StrComp),
	HOOK(vbscript, LCase),
	HOOK(vbscript, UCase),
	HOOK(vbscript, LTrim),
	HOOK(vbscript, RTrim),
	HOOK(vbscript, Trim),
	HOOK(vbscript, Space),
	HOOK(vbscript, String),
	HOOK(vbscript, InStr),
	HOOK(vbscript, InStrB),
	HOOK(vbscript, Escape),
	HOOK(vbscript, Unescape),
	HOOK(vbscript, AscB),
	HOOK(vbscript, ChrB),
	HOOK(vbscript, Asc),
	HOOK(vbscript, Chr),
	...
	HOOK(vbscript, Day),
	HOOK(vbscript, Month),
	HOOK(vbscript, Weekday),
	HOOK(vbscript, Year),
	HOOK(vbscript, Hour),
	HOOK(vbscript, Minute),
	HOOK(vbscript, Second),
	HOOK(vbscript, DateValue),
	HOOK(vbscript, TimeValue),
	HOOK(vbscript, DateSerial),
	HOOK(vbscript, TimeSerial),
	HOOK(vbscript, InputBox),
	HOOK(vbscript, MsgBox),
	HOOK(vbscript, CreateObject),
	//HOOK(vbscript, GetObject),
	HOOK(vbscript, DateAdd),
	HOOK(vbscript, DateDiff),
	HOOK(vbscript, DatePart),
	HOOK(vbscript, TypeName),
	HOOK(vbscript, Array),
	HOOK(vbscript, Erase),
	HOOK(vbscript, Filter),
	HOOK(vbscript, Join),
	HOOK(vbscript, Split),
	HOOK(vbscript, Replace),
	HOOK(vbscript, StrReverse),
	HOOK(vbscript, InStrRev),
	HOOK(vbscript, Eval),
	HOOK(vbscript, Execute),
	HOOK(vbscript, ExecuteGlobal),
	HOOK(vbscript, GetRef),
	HOOK(vbscript, SetLocale),
	HOOK(vbscript, GetLocale),
	HOOK(vbscript, GetUILanguage),
	HOOK(vbscript, LoadPicture),
	HOOK(vbscript, ScriptEngine),
	HOOK(vbscript, ScriptEngineMajorVersion),
	HOOK(vbscript, ScriptEngineMinorVersion),
	HOOK(vbscript, ScriptEngineBuildVersion),
	HOOK(vbscript, FormatNumber),
	HOOK(vbscript, FormatCurrency),
	HOOK(vbscript, FormatPercent),
	HOOK(vbscript, FormatDateTime),
	HOOK(vbscript, WeekdayName),
	HOOK(vbscript, MonthName),
	HOOK(vbscript, Round),
	HOOK(vbscript, Print),
};
